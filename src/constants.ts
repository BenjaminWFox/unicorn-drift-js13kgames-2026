...
export const SLIDE_BOOST = 10;
export const SLIDE_EXIT_BOOST = 24;
export const SLIDE_EXIT_KICK = 16;
export const SLIDE_TIME = 2.4;
export const SLIDE_CHARGE = 1.35;
export const SLIDE_DUMP = 0.38;
export const PAD_SPEED = 25;
export const PAD_TIME = 1.7;
export const PAD_HALF = ROAD_HALF * 0.34;
export const PAD_LANE = 3.2 + ROAD_HALF * 0.25 - PAD_HALF;
export const PAD_LEN = 12;
